...
const TrendingSeries = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await fetch(`https://api.themoviedb.org/3/trending/tv/${time_window}?api_key=68a69a694865c5c035f68ac8d602fd69`);
    ...
    return (
        <div className='flex justify-center'>
            <div className='w-[75%] p-5 '>
                <h2 className='text-2xl ml-24 my-5'> Trending Series </h2>
